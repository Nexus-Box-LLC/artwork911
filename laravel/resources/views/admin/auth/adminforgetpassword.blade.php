...
<html>
	<head>
        ...
        <title>ArtWork | forget password</title>
		...
		<div class="wrapper-page">
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="p-3">
						<form class="form-horizontal m-t-10" action="{{ route('forget.password.admin.post') }}" method="POST">
							@csrf
							...
							<div class="form-group row">
								...
								<div class="col-sm-7">
									<a href="{{route('admin')}}" class="text-muted text-center"><i class="mdi mdi-lock"></i> Remembered passwords ?</a>
								</div>
							</div>
						</form>
					</div>
