		...
		<div class="col-lg-12 col-md-12">
            <div class="card m-b-30">
				<div class="collapse m-b-20" id="add-new-vendor">
					<div class="card-body">
						<h4 class="header-title mt-0 mb-0">Add New Vendor</h4>
					</div>
                                   ...
                                   <div class="row">
										...
										<div class="col-md-12 checkbox_field">
											<div class="custom-control custom-checkbox">
												...
												<label class="custom-control-label" for="customCheck1">Vendor auto generated password *</label>
											</div>
										</div>
										...
										<div class="col-md-6 mt-3">
											...
											<button type="submit" class="btn btn-success"><i class="fa fa-plus"></i> Add New Vendor</button>
										</div>
									</div>
								</div>
							</div>
                ...
                <div class="card-body">
					<h4 class="header-title mt-0 mb-0 pull-left">Vendors List</h4>
					<a href="#add-new-vendor" data-toggle="collapse" aria-expanded="false" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Add New Vendor</a>
				</div>
				<div class="card-body p0">
					<table id="id-vendors" class="table table-bordered">
						<thead>
							<tr>
	...
	<div id="confirmModal" data-backdrop="static" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content" style="border-radius: 15px;">
				...
				<div class="modal-body">
					<strong>Are you sure to delete vendor?</strong>
				</div>
				<div class="modal-footer">
					<form method="POST" action="{{route('remove-vendor')}}" enctype="multipart/form-data">
						@csrf
						<input type="hidden" name="id" />
    ...
    <div class="modal fade show" style="overflow: auto;display: none;background: opacity: 0.5;" id="resetpasswordModal" data-keyboard="false" data-backdrop="static"  tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background: #;min-height: 200px;border-radius: 15px;">
                ...
                <div class="modal-body">
                <form action="{{route('reset-vendor-password')}}" method="POST">
                    @csrf
                    <input type="hidden" name="id" />
                    <div class="row">
                        <div class="col-md-12 password_field_pop">
                            <div class="form-group">
                                <label>Password</label>
                                <input type="password" name="password_pop" placeholder="Enter password" required class="form-control" />
                            </div>
                        </div>
						
						<div class="col-md-12 checkbox_field_pop">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="auto_generate_password_pop" class="custom-control-input" id="customCheck" value="1" required /> 
								<label class="custom-control-label" for="customCheck">Vendor auto generated password *</label>
							</div>
						</div>
...
<script>
    $(document).ready(function(){
        ...
        var tbl_vendors = $('#id-vendors').DataTable({
            processing: true,
            servrSide: true,
            "searching": true,
                language: {
        ...
        $(document).on('click', '.statusbtn', function(){
            ...
            if(confirm("Are you sure do you want to "+ (type==0 ? "Suspend" : "Activate")  +"?")){
