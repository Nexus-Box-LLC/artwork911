					...
					<div class="col-xl-12  mx-auto mt-n19">
						<div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h3 class="display-6 mb-3 text-white">Completed Orders</h3>
                                    </div>
                                        ...
                                        <div class="tab-pane fade @if($is_digitizing_tab) active show @endif" id="tab1-1">
                                            <div class="row">
                                                @if(count($digitizingorders) > 0 )
                                                    ...
                                                    @endforeach
                                                @else
                                                    <h4 align="center">Digitizing completed orders not found</h4>
                                                @endif
                                            </div>
                                            <div class="row">
                                         ...
                                         <div class="tab-pane fade @if(!$is_digitizing_tab) active show @endif" id="tab1-2">
                                            <div class="row">
                                                @if(count($vectorizingorders) > 0 )
                                                    ...
                                                    @endforeach
                                                @else
                                                    <h4 align="center">Vectorizing completed orders not found</h4>
                                                @endif
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 text-center">
