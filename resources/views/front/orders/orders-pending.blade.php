					...
					<div class="col-xl-12  mx-auto mt-n19">
						<div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h3 class="display-6 mb-3 text-white">Pending Orders</h3>
                                    </div>
                                            ...
                                            <div class="row">
                                                @if(count($digitizingorders) > 0 )
													...
													@php
														...
														$image = explode('.', $digitizingorder->file_1);
														$get_extension = end($image);
													@endphp
														...
														<div class="card">
															<figure class="card-img-top">
																...
																@if ((in_array($get_extension, $extension)))
																		...
																		@if(file_exists(public_path('Front/digitizing-order/'.$digitizingorder->file_1)))
																		 
																			<img class="img-h200 img-fx" src="{{asset('Front/digitizing-order/'.$digitizingorder->file_1)}}" alt=""><span class="bg"></span>
                                                    ...
                                                    @endforeach
                                                @else
                                                    <h4 align="center">Pending Digitizing order not found</h4>
                                                @endif
                                            </div>
                                            <div class="row">
                                         ...
                                         <div class="tab-pane fade @if(!$is_digitizing_tab) active show @endif" id="tab1-2">
                                            <div class="row">
                                                @if(count($vectorizingorders) > 0 )
													...
													@php
														$extension = array("jpg", "png", "gif", "jpeg");
														$image = explode('.', $vectorizingorder->file_1);
														$get_extension = end($image);
													@endphp
                                                    <div class="col-md-4">
														<div class="card">
															<figure class="card-img-top">
																@if ((in_array($get_extension, $extension)))
																	 ...
																	 @if(file_exists(public_path('Front/artwork-order/'.$vectorizingorder->file_1)))
																		    
																			<img class="img-h200 img-fx" src="{{asset('Front/artwork-order/'.$vectorizingorder->file_1)}}" alt=""><span class="bg"></span>
                                                    ...
                                                    @endforeach
                                                @else
                                                    <h4 align="center">Pending vectorizing order not found</h4>
                                                @endif
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 text-center">
