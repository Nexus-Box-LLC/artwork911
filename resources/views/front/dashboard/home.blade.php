...
<head>
	...
	<title>Embroidery Digitizing Service : Quality Custom Digitising Designs : Embroidery Patterns Digitization : Logo Digitizers</title>
	...
	<div class="content-wrapper">
        ...
        <div class="hero-slider-wrapper bg-dark">
			<div class="hero-slider owl-carousel dots-over" data-nav="false" data-dots="true" data-autoplay="true">
				<div class="owl-slide d-flex align-items-center bg-overlay bg-overlay-400" style="background-image: url('Front/assets/img/photos/bg7.jpg');">
					<div class="container">
						<div class="row">
				...
				<!--/.owl-slide -->
				<div class="owl-slide d-flex align-items-center bg-overlay bg-overlay-400" style="background-image: url('Front/assets/img/photos/bg8.jpg');">
					<div class="container light-gallery-wrapper">
						<div class="row">
							<div class="col-md-11 col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center">
								...
								<div class="animated-caption" data-anim="animate__slideInUp" data-anim-delay="1500"><a href="https://vimeo.com/374265101" class="btn btn-circle btn-white btn-play ripple mx-auto mb-5 lightbox"><i class="icn-caret-right"></i></a></div>
							</div>
							<!--/column -->
						</div>
						<!--/.row -->
				...
				<!--/.owl-slide -->
				<div class="owl-slide d-flex align-items-center bg-overlay bg-overlay-400" style="background-image: url('Front/assets/img/photos/bg9.jpg');">
					<div class="container">
						<div class="row">
