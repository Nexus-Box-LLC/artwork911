    ...
    <div className="sample_work_section darkcolor">
      <div className="container">
        <div className="flex justify-between row">
          ...
          <div className="swsr_container">
            <div className="swsr_timg">
              <div className="swsr_img"><Image className="sw_img" src="/vector_art/as_sw1.jpg" alt="sample_work " width={497} height={331} priority /></div>
              <div className="swsr_img"><Image className="sw_img" src="/vector_art/as_sw2.jpg" alt="sample_work " width={497} height={331} priority /></div>
            </div>

            <div className="swsr_oimg">
              
              <div className="swsr_img"><Image className="sw_img" src="/vector_art/as_sw3.jpg" alt="sample_work " width={497} height={331} priority /></div>
            </div>

            <div className="swsr_img_whead">
              <div className="swsr_content"><h2>Sample Works</h2>
              We don’t just talk the talk, we walk the walk. Check out some of our previous Embroidery Digitizing works for our happy clients.</div>
              <div className="swsr_img"><Image className="sw_img" src="/vector_art/as_sw4.jpg" alt="sample_work " width={497} height={331} priority /></div>
            </div>
